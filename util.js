/*
 * @Author: JackChen 
 * @Date: 2018-11-05 18:20:16 
 * @Last Modified by: JackChen
 * @Last Modified time: 2019-08-30 11:35:06
 */
(function (root) {
    root.Util = {
        ...
        extend: function () {
            ...
            root.v = this.v;
            root.h = this.h;
            root.displayB = this.displayB;
            root.displayN = this.displayN;
        },
        /**
        ...
        cookie: {
            ...
            delAll: function () {
                ...
                for (var i = 0; i < arr.length; i++) {
                    var eqIdx = arr[i].indexOf('=');
                    document.cookie = arr[i].substring(0, eqIdx) + '=;expires=' + new Date().toGMTString() + ';path=/';
                }
            }
        },
        /**
